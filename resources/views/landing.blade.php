...
<body class="bg-carbon text-off-white">
    <section class="relative text-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 py-32 text-center z-10">
            ...
            <a href="{{ route('login.form') }}"
                class="bg-blood-red text-off-white font-semibold px-6 py-3 rounded hover:bg-vivid-red transition">
                Comienza Ahora
            </a>
        </div>
  ...
  <!-- Features Section -->
  <section id="features" class="py-20 bg-carbon">
  <div class="max-w-7xl mx-auto px-4">
    <h2 class="text-3xl font-bold text-center mb-12">Traducciones y contenido libre</h2>
    <div class="grid md:grid-cols-3 gap-8">

      <!-- Tarjeta 1 -->
      <div class="bg-steel-gray p-6 rounded shadow hover:shadow-lg transition text-center">
        <!-- Ícono -->
        <div class="flex justify-center mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-vivid-red" fill="none"
        ...
        <p class="text-off-white/80">Comparte tus propias pasiones y conecta con los demás.</p>
      </div>
      ...
      <div class="bg-steel-gray p-6 rounded shadow hover:shadow-lg transition text-center">
        ...
        <p class="text-off-white/80">Contenido completamente libre.</p>
      </div>
      ...
      <div class="bg-steel-gray p-6 rounded shadow hover:shadow-lg transition text-center">
        ...
        <p class="text-off-white/80">Con administración encargada del control de calidad.</p>
      </div>
  ...
  <!-- Testimonials Section -->
    <section id="destacados" class="py-20 bg-steel-gray">
    <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-3xl font-bold text-center mb-12">Mangas Destacados</h2>

        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Tarjeta 1 -->
        <div
            class="bg-carbon rounded-2xl overflow-hidden shadow hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
            <img src="https://i.redd.it/fusf36sp3m641.jpg"
            alt="Chainsaw Man"
            class="w-full h-64 object-cover">
            <div class="p-6">
            <h3 class="text-xl font-semibold mb-2">Chainsaw Man</h3>
            <p class="text-off-white/80 mb-4">Un joven cazador de demonios con una motosierra como corazón, en un mundo donde el horror y la humanidad se entrelazan.</p>
            <a href="#"
        ...
        <div
            ...
            class="w-full h-64 object-cover">
            <div class="p-6">
            <h3 class="text-xl font-semibold mb-2">Jujutsu Kaisen</h3>
            <p class="text-off-white/80 mb-4">Hechicería, maldiciones y batallas épicas se combinan en una historia llena de acción y emoción.</p>
            <a href="#"
                class="inline-block bg-blood-red text-off-white px-4 py-2 rounded hover:bg-vivid-red transition">
                Leer más
            </a>
        ...
        <div
            ...
            class="w-full h-64 object-cover">
            <div class="p-6">
            <h3 class="text-xl font-semibold mb-2">Tokyo Ghoul</h3>
            <p class="text-off-white/80 mb-4">Una historia oscura y profunda sobre identidad y supervivencia en un mundo donde los monstruos viven entre nosotros.</p>
            <a href="#"
                class="inline-block bg-blood-red text-off-white px-4 py-2 rounded hover:bg-vivid-red transition">
                Leer más
            </a>
    ...
    <section id="lanzamientos" class="py-20 bg-carbon">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-3xl font-bold text-center mb-12">Lanzamientos del staff</h2>

            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Card 1 -->
            <div class="bg-steel-gray rounded-2xl shadow hover:shadow-xl transition transform hover:-translate-y-1 overflow-hidden">
                <img src="{{ asset('Images/cap-8.webp') }}" 
                    alt="Danhoji 1:5 no Sekai - Capítulo 8" 
                    class="w-full h-64 object-cover object-top">
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2">Danhoji 1:5 no Sekai - Capítulo 8</h3>
                    <p class="text-off-white/80 mb-4">¡El capítulo 8 llega con la misma tensión de siempre!</p>
                    <a href="#" class="inline-block bg-blood-red text-off-white px-4 py-2 rounded hover:bg-vivid-red transition">
                        Leer más
                    </a>
                </div>
            </div>
            ...
            <div class="bg-steel-gray rounded-2xl shadow hover:shadow-xl transition transform hover:-translate-y-1 overflow-hidden">
                ...
                class="w-full h-64 object-cover object-top">
                <div class="p-6">
                <h3 class="text-xl font-semibold mb-2">Danhoji 1:5 no Sekai - Capítulo 9</h3>
                <p class="text-off-white/80 mb-4">FInalmente el desenlace de las acosadoras jajalol</p>
                <a href="#"
                    class="inline-block bg-blood-red text-off-white px-4 py-2 rounded hover:bg-vivid-red transition">
                    Leer más
                </a>
            ...
            <div class="bg-steel-gray rounded-2xl shadow hover:shadow-xl transition transform hover:-translate-y-1 overflow-hidden">
                ...
                class="w-full h-64 object-cover object-top">
                <div class="p-6">
                <h3 class="text-xl font-semibold mb-2">Danhoji 1:5 no Sekai - Capítulo 10</h3>
                <p class="text-off-white/80 mb-4">Se anuncia un nuevo spin-off de Tokyo Ghoul con personajes inéditos y nuevas tramas.</p>
                <a href="#"
                    class="inline-block bg-blood-red text-off-white px-4 py-2 rounded hover:bg-vivid-red transition">
                    Leer más
                </a>
    ...
    <section id="social" class="py-20 bg-steel-gray">
    <div class="max-w-4xl mx-auto px-4 text-center">
        <h2 class="text-3xl font-bold mb-8">Síguenos y Apóyanos 💖</h2>
        <p class="text-off-white/80 mb-10">Sigue nuestras redes para no perderte los próximos lanzamientos y apóyanos para seguir creando contenido increíble.</p>

        <!-- Redes Sociales -->
        <div class="flex justify-center gap-8 mb-12">
        <a href="https://twitter.com" target="_blank" class="text-off-white/80 hover:text-vivid-red transition transform hover:scale-110">
        ...
        <a href="https://instagram.com" target="_blank" class="text-off-white/80 hover:text-vivid-red transition transform hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://facebook.com" target="_blank" class="text-off-white/80 hover:text-vivid-red transition transform hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://youtube.com" target="_blank" class="text-off-white/80 hover:text-vivid-red transition transform hover:scale-110">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="https://paypal.me/" target="_blank"
            class="flex items-center gap-2 bg-blood-red text-off-white px-6 py-3 rounded-lg font-semibold hover:bg-vivid-red transition transform hover:-translate-y-1">
    ...
    <!-- Footer -->
    <footer class="bg-carbon text-off-white pt-12 pb-6">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-col">
            ...
            <li><a href="#lanzamientos" class="hover:text-vivid-red transition">Lanzamientos</a></li>
            <li><a href="#redes" class="hover:text-vivid-red transition">Redes</a></li>
            </ul>
        </div>
        ...
        <div class="flex flex-col">
            ...
            <a href="https://twitter.com" target="_blank" class="hover:text-vivid-red transition">
                <i class="fab fa-twitter"></i>
            </a>
            <a href="https://instagram.com" target="_blank" class="hover:text-vivid-red transition">
                <i class="fab fa-instagram"></i>
            </a>
            <a href="https://facebook.com" target="_blank" class="hover:text-vivid-red transition">
                <i class="fab fa-facebook"></i>
            </a>
            <a href="https://www.youtube.com" target="_blank" class="hover:text-vivid-red transition">
